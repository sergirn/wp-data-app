    ...
    <CardHeader className="p-0">
      <div className="relative overflow-hidden rounded-xl border-2">
        ...
        {currentClub?.logo_url ? (
          <div className="pointer-events-none absolute -right-16 -top-16 h-[420px] w-[420px] opacity-[0.07] dark:opacity-[0.08]">
        ...
        <div className="relative flex items-stretch">
          ...
          <div className="flex-1 min-w-0 px-4 sm:px-5 flex flex-col justify-center">
            <div className="flex flex-wrap items-center gap-2">
              <CardTitle className="text-lg sm:text-xl md:text-2xl leading-tight truncate">
                {player.name}
              </CardTitle>

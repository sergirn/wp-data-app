			...
			<div className="space-y-6">
				...
				<div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
					...
					<Card>
						<CardContent className="pt-6">
							<div className="text-center">
								<p className="text-4xl font-bold text-green-700 dark:text-green-300">{stats.portero_rival_goles_totales}</p>
...
function GoalkeeperTotalStats({ stats }: { stats: any }) {
	const savePercentage =
		stats.portero_paradas_totales + stats.portero_goles_totales > 0
			? ((stats.portero_paradas_totales / (stats.portero_paradas_totales + stats.portero_goles_totales)) * 100).toFixed(1)
			: "0.0";
...
function EfficiencyView({ player, stats }: { player: Player; stats: any }) {
	...
	const overallEfficiency = stats.tiros_totales > 0 ? ((stats.goles_totales / stats.tiros_totales) * 100).toFixed(1) : "0.0";
					...
					<div className="grid md:grid-cols-2 gap-6 items-center">
						<div className="flex flex-col items-center justify-center">
							<ChartContainer config={overallConfig} className="h-[250px] w-full">
								<PieChart>
									<Pie data={overallData} dataKey="value" nameKey="name" innerRadius={60} outerRadius={100} paddingAngle={2}>
						...
						<div className="space-y-4">
							...
							<div className="grid grid-cols-2 gap-4">
								...
								<div className="text-center p-4 bg-red-500/10 rounded-lg">
									<p className="text-3xl font-bold text-red-600 dark:text-red-400">{stats.tiros_totales - stats.goles_totales}</p>
									...
									<div className="space-y-4">
										...
										<div className="grid grid-cols-2 gap-4">
											<div className="text-center p-4 bg-teal-500/10 rounded-lg">
												<p className="text-3xl font-bold text-teal-600 dark:text-teal-400">{stats.portero_paradas_totales}</p>
									...
									<>
										...
										<div className="space-y-4">
											...
											<div className="grid grid-cols-2 gap-4">
												...
												<div className="text-center p-4 bg-red-500/10 rounded-lg">
													<p className="text-3xl font-bold text-red-600 dark:text-red-400">{stats.portero_goles_penalti}</p>

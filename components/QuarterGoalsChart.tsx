...
import { BarChart, Bar, ResponsiveContainer, XAxis, YAxis, CartesianGrid, ReferenceLine } from "recharts";
					...
					>
						<ResponsiveContainer width="100%" height="100%">
							...
							>
								...
								<YAxis type="category" dataKey="quarter" fontSize={12} width={42} tickMargin={8} axisLine={false} tickLine={false} />

								{/* ✅ línea exactamente en el medio */}
								<ReferenceLine x={0} stroke="hsl(var(--border))" strokeWidth={3} ifOverflow="extendDomain" />
								...
								<Table className="min-w-[640px]">
									...
									<TableBody>
										{quarterMatches.map((m, idx) => (
											<TableRow key={m.id} className={`${idx % 2 === 0 ? "bg-muted/20" : "bg-transparent"} hover:bg-muted/40`}>

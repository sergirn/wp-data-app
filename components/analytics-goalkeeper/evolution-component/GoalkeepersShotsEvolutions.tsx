...
export type GoalkeeperShotForChart = {
  id: number | string;
  match_id: number; // ✅ necesario para filtrar por partido
...
export function GoalkeeperShotsGoalChart({
    ...
    // ✅ Filtra por portero y (si existe) por partido
    const filteredShots = React.useMemo(() => {
        ...
        if (typeof matchId === "number" && s.match_id !== matchId) return false; // ✅ aquí
        return true;
        });

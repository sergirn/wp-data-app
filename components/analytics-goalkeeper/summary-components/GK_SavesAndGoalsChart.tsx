        ...
        >
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data} margin={{ top: 8, right: 12, left: 0, bottom: 0 }}>
              ...
              <Area type="monotone" dataKey="saves" name="Paradas" stroke="var(--color-saves)" fill="url(#gkFillSaves)" strokeWidth={2} dot={false} />
              <Area type="monotone" dataKey="goals" name="Goles recibidos" stroke="var(--color-goals)" fill="url(#gkFillGoals)" strokeWidth={2} dot={false} />
            </AreaChart>
          </ResponsiveContainer>
        </ChartContainer>
      )}

  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Asigna un peso (positivo o negativo) a cada campo de estadistica.
          Cada usuario tiene sus propias valoraciones independientes.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="flex gap-2">
          <Button
            variant={tab === "field" ? "default" : "outline"}
            size="sm"
          ...
          <Button
            variant={tab === "goalkeeper" ? "default" : "outline"}
            size="sm"
